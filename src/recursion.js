...
var arraySum = function(array) {
  ...
  let currentItem = copy.shift();
    ...
    // if that item is an array invoke arraySum again
  if (Array.isArray(currentItem)) {
	return arraySum(currentItem) + arraySum(copy); 
  }
    // if not sum integer 
  return currentItem + arraySum(copy);  
};
...
var reverse = function(oldString, newStringArray = []) {
  // change oldString into array
  if (!Array.isArray(oldString)) {
  ...
  // pop off last character from oldString
  // add it to newString  
  // recurse
  return reverse(oldString, newStringArray);
};
